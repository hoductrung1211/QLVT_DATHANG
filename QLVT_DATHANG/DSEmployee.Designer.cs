...
namespace QLVT_DATHANG {
    ...
    public partial class DSEmployee : global::System.Data.DataSet {
        ...
        public partial class NhanVienDataTable : global::System.Data.TypedTableBase<NhanVienRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public NhanVienRow AddNhanVienRow(int MaNV, string Ho, string Ten, string CMND, string DiaChi, System.DateTime NgaySinh, double Luong, string MaCN, bool TrangThaiXoa, System.Guid rowguid) {
...
SELECT MaSoDDH, Ngay, NhaCC, MaNV, MaKho, rowguid FROM DatHang WHERE (MaSoDDH = @MaSoDDH)";
    ...
    public partial class NhanVienTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[NhanVien] ([MaNV], [Ho], [Ten], [CMND], [DiaChi], [NgaySinh], [Luong], [MaCN], [TrangThaiXoa], [rowguid]) VALUES (@MaNV, @Ho, @Ten, @CMND, @DiaChi, @NgaySinh, @Luong, @MaCN, @TrangThaiXoa, @rowguid);
SELECT MaNV, Ho, Ten, CMND, DiaChi, NgaySinh, Luong, MaCN, TrangThaiXoa, rowguid FROM NhanVien WHERE (MaNV = @MaNV)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@MaNV", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "MaNV", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[NhanVien] SET [MaNV] = @MaNV, [Ho] = @Ho, [Ten] = @Ten, [CMND] = @CMND, [DiaChi] = @DiaChi, [NgaySinh] = @NgaySinh, [Luong] = @Luong, [MaCN] = @MaCN, [TrangThaiXoa] = @TrangThaiXoa, [rowguid] = @rowguid WHERE (([MaNV] = @Original_MaNV) AND ([Ho] = @Original_Ho) AND ([Ten] = @Original_Ten) AND ((@IsNull_CMND = 1 AND [CMND] IS NULL) OR ([CMND] = @Original_CMND)) AND ((@IsNull_DiaChi = 1 AND [DiaChi] IS NULL) OR ([DiaChi] = @Original_DiaChi)) AND ((@IsNull_NgaySinh = 1 AND [NgaySinh] IS NULL) OR ([NgaySinh] = @Original_NgaySinh)) AND ((@IsNull_Luong = 1 AND [Luong] IS NULL) OR ([Luong] = @Original_Luong)) AND ((@IsNull_MaCN = 1 AND [MaCN] IS NULL) OR ([MaCN] = @Original_MaCN)) AND ((@IsNull_TrangThaiXoa = 1 AND [TrangThaiXoa] IS NULL) OR ([TrangThaiXoa] = @Original_TrangThaiXoa)) AND ([rowguid] = @Original_rowguid));
SELECT MaNV, Ho, Ten, CMND, DiaChi, NgaySinh, Luong, MaCN, TrangThaiXoa, rowguid FROM NhanVien WHERE (MaNV = @MaNV)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@MaNV", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "MaNV", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT MaNV, Ho, Ten, CMND, DiaChi, NgaySinh, Luong, MaCN, TrangThaiXoa, rowguid " +
                "FROM dbo.NhanVien";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(int MaNV, string Ho, string Ten, string CMND, string DiaChi, global::System.Nullable<global::System.DateTime> NgaySinh, global::System.Nullable<double> Luong, string MaCN, global::System.Nullable<bool> TrangThaiXoa, System.Guid rowguid) {
        ...
        public virtual int Update(
                    ...
                    global::System.Nullable<bool> Original_TrangThaiXoa, 
                    System.Guid Original_rowguid) {
            return this.Update(Original_MaNV, Ho, Ten, CMND, DiaChi, NgaySinh, Luong, MaCN, TrangThaiXoa, rowguid, Original_MaNV, Original_Ho, Original_Ten, Original_CMND, Original_DiaChi, Original_NgaySinh, Original_Luong, Original_MaCN, Original_TrangThaiXoa, Original_rowguid);
        }
    }
